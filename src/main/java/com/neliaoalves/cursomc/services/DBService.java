...
import com.neliaoalves.cursomc.domain.ItemPedido;
import com.neliaoalves.cursomc.domain.PagamentoComBoleto;
import com.neliaoalves.cursomc.domain.PagamentoComCartao;
import com.neliaoalves.cursomc.domain.Pedido;
import com.neliaoalves.cursomc.domain.Produto;
import com.neliaoalves.cursomc.enums.EstadoPagamento;
...
import com.neliaoalves.cursomc.repositories.EstadoRepository;
import com.neliaoalves.cursomc.repositories.ItemPedidoRepository;
import com.neliaoalves.cursomc.repositories.PagamentoRepository;
import com.neliaoalves.cursomc.repositories.PedidoRepository;
import com.neliaoalves.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p9 = new Produto(null, "Abajoul", 100.00);
		Produto p10 = new Produto(null, "Pendulo", 180.00);
		...
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p8, p10, p11));
		...
		Cliente cli1 = new Cliente(null, "João Arthur JR", "tupi_1800@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli1.getTelefone().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "tupi_1800@gmail.com", "87329762083", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefone().addAll(Arrays.asList("93883323", "34258393"));
